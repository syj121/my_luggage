class CreateLuggages < ActiveRecord::Migration[5.2]
  def change
    create_table :luggages do |t|
      t.string :no, null: false, default: "", comment: "托运单号 201912210001"
      ...
      t.string :user_name, null: false, default: "", comment: "用户名"
      t.string :mobile, comment: "手机号"
      t.integer :card_type, default: 1, comment: "证件类别"
      t.string :card_no, null: false, default: "", comment: "证件号"
